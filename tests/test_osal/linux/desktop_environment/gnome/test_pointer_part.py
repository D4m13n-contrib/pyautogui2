"""Tests for Gnome Desktop Environment Parts.
...
class TestGnomePointerPart:
    """Tests for GnomeDesktopPart."""

    def test_get_primary_button_returns_left_when_touchpad_left_handed(self, linux_de_gnome_pointer):
        """get_primary_button() returns 'left' when touchpad is left-handed mode."""
        with patch("subprocess.check_output") as mock_subprocess:
            mock_subprocess.return_value = "left\n"

            button = linux_de_gnome_pointer.get_primary_button()
    ...
    def test_get_primary_button_returns_right_when_touchpad_right_handed(self, linux_de_gnome_pointer):
    ...
    def test_get_primary_button_returns_left_when_not_left_handed(self, linux_de_gnome_pointer):
    ...
    def test_get_primary_button_returns_right_when_left_handed(self, linux_de_gnome_pointer):
    ...
    def test_get_primary_button_handles_subprocess_error(self, linux_de_gnome_pointer):
    ...
    def test_get_primary_button_handles_invalid_output(self, linux_de_gnome_pointer):
    ...
    def test_get_primary_button_uses_cache(self, linux_de_gnome_pointer):
        """get_primary_button() uses cached value."""
        with patch("subprocess.check_output") as mock_subprocess:
            mock_subprocess.return_value = "false\n"
            ...
            # Call again: use cached value (subprocess should be not called)
            button = linux_de_gnome_pointer.get_primary_button()
            assert button == ButtonName.LEFT
