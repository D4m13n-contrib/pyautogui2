"""GSettingsPointerPart - gsettings part shared for all Linux pointers."""
import subprocess
...
class GSettingsPointerPart(AbstractPointer):
    """GNOME settings pointer configuration handler.

    Provides a pointer behavior, primarily detecting the user's
    ...
    def _get_gsetting(self, schema: str, key: str) -> str:
        ...
        Args:
            schema (str): Gnome schema name (e.g., "org.gnome.desktop.peripherals.mouse").
